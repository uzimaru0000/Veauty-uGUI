...
{PropertyClassesTemplate(uGUIType, propertyTypes)}
    ...
    private static string InitTemplate(Type uGUIType)
    {
            ...
            return @"public override UnityEngine.GameObject Init(UnityEngine.GameObject go)
        {
            ...
            templateImage.color = new UnityEngine.Color(0.10f, 0.11f, 0.14f);
            ...
            item.AddComponent<UnityEngine.UI.LayoutElement>().preferredHeight = 28f;
            ...
            itemRect.sizeDelta = new UnityEngine.Vector2(0f, 28f);
            ...
            itemBgImage.color = new UnityEngine.Color(0.24f, 0.26f, 0.32f);
